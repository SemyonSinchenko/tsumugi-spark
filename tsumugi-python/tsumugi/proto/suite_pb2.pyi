...
class Check(_message.Message):
    ...
    class Constraint(_message.Message):
        __slots__ = ("analyzer", "long_expectation", "double_expectation", "sign", "hint", "name")
        ...
        hint: str
        name: str
        def __init__(self, analyzer: _Optional[_Union[_analyzers_pb2.Analyzer, _Mapping]] = ..., long_expectation: _Optional[int] = ..., double_expectation: _Optional[float] = ..., sign: _Optional[_Union[Check.ComparisonSign, str]] = ..., hint: _Optional[str] = ..., name: _Optional[str] = ...) -> None: ...
    ...
    def __init__(self, checkLevel: _Optional[_Union[CheckLevel, str]] = ..., description: _Optional[str] = ..., constraints: _Optional[_Iterable[_Union[Check.Constraint, _Mapping]]] = ...) -> None: ...
...
class AnomalyDetection(_message.Message):
    ...
    class AnomalyCheckConfig(_message.Message):
        __slots__ = ("level", "description", "with_tag_values", "after_date", "before_date")
        ...
        after_date: int
        before_date: int
        def __init__(self, level: _Optional[_Union[CheckLevel, str]] = ..., description: _Optional[str] = ..., with_tag_values: _Optional[_Mapping[str, str]] = ..., after_date: _Optional[int] = ..., before_date: _Optional[int] = ...) -> None: ...
    ...
    def __init__(self, anomaly_detection_strategy: _Optional[_Union[_strategies_pb2.AnomalyDetectionStrategy, _Mapping]] = ..., analyzer: _Optional[_Union[_analyzers_pb2.Analyzer, _Mapping]] = ..., config: _Optional[_Union[AnomalyDetection.AnomalyCheckConfig, _Mapping]] = ...) -> None: ...

class VerificationSuite(_message.Message):
    __slots__ = ("data", "checks", "required_analyzers", "file_system_repository", "spark_table_repository", "result_key", "anomaly_detections", "compute_row_level_results")
    ...
    class ResultKey(_message.Message):
        ...
        def __init__(self, dataset_date: _Optional[int] = ..., tags: _Optional[_Mapping[str, str]] = ...) -> None: ...
    ...
    required_analyzers: _containers.RepeatedCompositeFieldContainer[_analyzers_pb2.Analyzer]
    ...
    def __init__(self, data: _Optional[bytes] = ..., checks: _Optional[_Iterable[_Union[Check, _Mapping]]] = ..., required_analyzers: _Optional[_Iterable[_Union[_analyzers_pb2.Analyzer, _Mapping]]] = ..., file_system_repository: _Optional[_Union[VerificationSuite.FileSystemRepository, _Mapping]] = ..., spark_table_repository: _Optional[_Union[VerificationSuite.SparkTableRepository, _Mapping]] = ..., result_key: _Optional[_Union[VerificationSuite.ResultKey, _Mapping]] = ..., anomaly_detections: _Optional[_Iterable[_Union[AnomalyDetection, _Mapping]]] = ..., compute_row_level_results: bool = ...) -> None: ...
