...
class Histogram(_message.Message):
    ...
    def __init__(self, column: _Optional[str] = ..., max_detail_bins: _Optional[int] = ..., where: _Optional[str] = ..., compute_frequencies_as_ratio: bool = ..., aggregate_function: _Optional[_Union[Histogram.AggregateFunction, str]] = ...) -> None: ...
