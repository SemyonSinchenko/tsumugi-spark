...
class VerificationSuite(_message.Message):
    __slots__ = ("data", "checks", "required_analyzers", "file_system_repository", "spark_table_repository", "result_key", "anomaly_detections")
