...
class AnomalyDetectionStrategy(_message.Message):
    __slots__ = (
        "absolute_change_strategy",
        "batch_normal_strategy",
        "online_normal_strategy",
        "relative_rate_of_change_strategy",
        "simple_thresholds_strategy",
    )
    ...
    def __init__(
        self,
        absolute_change_strategy: _Optional[
            _Union[AbsoluteChangeStrategy, _Mapping]
        ] = ...,
        batch_normal_strategy: _Optional[_Union[BatchNormalStrategy, _Mapping]] = ...,
        online_normal_strategy: _Optional[_Union[OnlineNormalStrategy, _Mapping]] = ...,
        relative_rate_of_change_strategy: _Optional[
            _Union[RelativeRateOfChangeStrategy, _Mapping]
        ] = ...,
        simple_thresholds_strategy: _Optional[
            _Union[SimpleThresholdStrategy, _Mapping]
        ] = ...,
    ) -> None: ...
...
class AbsoluteChangeStrategy(_message.Message):
    ...
    def __init__(
        self,
        max_rate_decrease: _Optional[float] = ...,
        max_rate_increase: _Optional[float] = ...,
        order: _Optional[int] = ...,
    ) -> None: ...
...
class BatchNormalStrategy(_message.Message):
    ...
    def __init__(
        self,
        lower_deviation_factor: _Optional[float] = ...,
        upper_deviation_factor: _Optional[float] = ...,
        include_interval: bool = ...,
    ) -> None: ...

class OnlineNormalStrategy(_message.Message):
    __slots__ = (
        "lower_deviation_factor",
        "upper_deviation_factor",
        "ignore_start_percentage",
        "ignore_anomalies",
    )
    LOWER_DEVIATION_FACTOR_FIELD_NUMBER: _ClassVar[int]
    UPPER_DEVIATION_FACTOR_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(
        ...
        lower_deviation_factor: _Optional[float] = ...,
        upper_deviation_factor: _Optional[float] = ...,
        ignore_start_percentage: _Optional[float] = ...,
        ignore_anomalies: bool = ...,
    ) -> None: ...
...
class SimpleThresholdStrategy(_message.Message):
    ...
    upper_bound: float
    def __init__(
        self, lower_bound: _Optional[float] = ..., upper_bound: _Optional[float] = ...
    ) -> None: ...
